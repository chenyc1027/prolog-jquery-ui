...
numeric_filter - text filter allowing to use the comporison operators in it. Retrieves values which contain mask defined through text field. 
Possible comporison operators: 
'=' - equal to; 
'>' - greater than; 
'<' - less than; 
'?' - less or equal; 
'>=' - greater or equal; 
'n1..n2' - the range of values. |
